...
public class NotificationUtils {
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        builder.setStyle(new NotificationCompat.BigTextStyle().bigText(context.getString(R.string.charging_reminder_notification_body)));
        ...
        notificationManager.notify(UNIQUE_PENDING_ID, builder.build());
        // COMPLETED (12) Trigger the notification by calling notify on the NotificationManager.
        // Pass in a unique ID of your choosing for the notification and notificationBuilder.build()
    }

    public static final int UNIQUE_PENDING_ID = 22;
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, UNIQUE_PENDING_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
    ...
    private static Bitmap largeIcon(Context context) {
        ...
        Resources rObject = context.getResources();
        // COMPLETED (6) Create and return a bitmap using BitmapFactory.decodeResource, passing in the
        // resources object and R.drawable.ic_local_drink_black_24px
        return BitmapFactory.decodeResource(rObject, R.drawable.ic_local_drink_black_24px);
    }
